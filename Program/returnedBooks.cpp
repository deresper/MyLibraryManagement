...
void returnBookBill(char *nameReader, char *nameBook, int numBor, int numRet, long moneyPayement)
{
	...
	printf("|      <Quan Ly Thu Vien>                               <Nguoi Tra Sach>           |\n");
	printf("|                                                                                  |\n");
	printf("|                                                                                  |\n");
	printf("------------------------------------------------------------------------------------\n");
...
void returnBook()
{
	...
	strcpy(nameReader, llBorBook.head->brBook.Fullname);
	...
	strcpy(nameBook, (llBorBook.head)->brBook.nameBook);
