...
2 - Chuyên viên
3 - Quản lý
Nếu đăng nhập thất bại trả về 0
*/
int Login()
{
	showTitleHeader();
...
int wantEdit()
{
	...
	do
	{
		...
		printf("Ban con muon chinh sua nua khong? Nhap 0 (Khong), Nhap 1 (Co) va nhan Enter: ");
		scanf("%d", &edit);
		if (edit == 1)
			return 1;
		else if (edit == 0)
